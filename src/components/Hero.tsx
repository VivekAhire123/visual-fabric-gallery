            ...
            <div className="space-y-4">
              <div className="flex items-center justify-center lg:justify-start gap-3 group">
                ...
                <div className="text-left">
                  ...
                  <a href="https://wa.me/917778036741?text=Hello%20from%20Tata%20Matching%20Center!" className="text-white hover:text-accent transition-colors font-medium text-lg">
                    +91 77780 36741
                  </a>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-center lg:justify-start gap-3 group">
                ...
                <div className="text-left">
                  ...
                  <a 
                    href="https://share.google/IqTeTIu0bmrsc8Hsy" 
                    target="_blank" 
